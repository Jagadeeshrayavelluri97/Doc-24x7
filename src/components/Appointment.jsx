          ...
          <form onSubmit={onSubmit}>
            ...
            <div className='mb-4'>
              ...
              <select
                ...
                <option>Dr. Arjun - Dermatology</option>
                <option>Dr. Hima Bindhu - Dentistry</option>
                <option>Dr. Sruthi - Gynecology</option>
              </select>
            </div>
            <div className='mb-4'>
              <label className='black text-gray-800 mb-2'>Date</label>
              <input
                type="date"
                name="date"
                required
